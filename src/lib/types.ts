  ...
  public: {
    Tables: {
      ...
      family_attendance: {
        ...
        Relationships: [
          {
            foreignKeyName: "family_attendance_checked_in_by_fkey"
          ...
          {
            foreignKeyName: "family_attendance_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "family_attendance_family_id_fkey"
            columns: ["family_id"]
            isOneToOne: false
      ...
      student_attendance: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "student_attendance_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      teacher_class: { Args: never; Returns: string }
    }
    Enums: {
      [_ in never]: never
    }
